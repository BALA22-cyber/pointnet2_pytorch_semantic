...
from data_utils.BuildingDataLoader2 import BuildingDataset
import torch
import datetime
import logging
...
def parse_args():
    ...
    parser.add_argument('--step_size', type=int, default=12, help='Decay step for lr decay [default: every 10 epochs]')
...
def main(args):
    ...
    root = '/mnt/e/pointnet2_pytorch_semantic/data/semantic_raw_label_removed/sampled_h5'
    ...
    def load_pretrained_weights(model, pretrained_dict):
        ...
        # Filter out the weights for the final layer that don't match
    ...
    try: 
        ...
        print("try 1")
        classifier = load_pretrained_weights(classifier,checkpoint)
        print("try2")
        log_string('Use pretrain model')


    # try:
    #     print("checkpoint:    ",str(experiment_dir) + '/checkpoints/best_model.pth')
    #     checkpoint = torch.load(str(experiment_dir) + '/checkpoints/best_model.pth')
    #     print("step2 ")
    #     start_epoch = checkpoint['epoch']
    #     print(start_epoch)
