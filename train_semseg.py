...
def main(args):
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        writer.add_scalar('Loss/train', loss_sum / num_batches, epoch)
        writer.add_scalar('Accuracy/train', total_correct / float(total_seen), epoch)
        ...
        with torch.no_grad():
            ...
            writer.add_scalar('Loss/eval', loss_sum / num_batches, epoch)
            writer.add_scalar('Accuracy/eval', total_correct / float(total_seen), epoch)
